...
urlpatterns = [
    ...
    path('voice-call/<int:call_id>/status/', views.voice_call_status, name='voice_call_status'),
    path('voice-call/<int:call_id>/decline/', views.decline_voice_call, name='decline_voice_call'),
